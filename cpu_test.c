...
int test_cpu_exec() {
  ...
  struct test {
    ...
    {"LD A, E", {.E = 0x01}, 1, {.A = 0x01, .E = 0x01}, {}, {}},
    {"LD B, 0xFF", {}, 2, {.B = 0xFF}, {}, {}},
    {"LD C, (HL)", {.C = 0xAA, .H = 0x10, .L = 0x11}, 2, {.H = 0x10, .L = 0x11}, {}, {}},

    /*{"LD (HL), D", {.D = 0x1F, .H = 0x10, .L = 0x11}, 2, {.H = 0x10, .L = 0x11}, {0x1011}, {0x1F}},

    {"LD (HL), 0xAB", {.H = 0x10, .L = 0x11}, 3, {.H = 0x10, .L = 0x11}, {0x1011}, {0xAB}},
    {"LD A, (BC)", {.A = 0xAA, .B = 0x0A, .C = 0xA0}, 2, {.B = 0x0A, .C = 0xA0}, {}, {}},
    {"LD A, (DE)", {.A = 0xBB, .D = 0x0D, .E = 0xE0}, 2, {.B = 0x0D, .E = 0xE0}, {}, {}},

    {"LD (BC), A", {.A = 0xAA, .B = 0x0B, .C=0x0C}, 2, {.A = 0xAA, .B = 0x0B, .C=0x0C}, {0x0B0C}, {0xAA}},
    {"LD (DE), A", {.A = 0xAA, .D = 0x0D, .E=0x0E}, 2, {.A = 0xAA, .B = 0x0B, .C=0x0C}, {0x0D0E}, {0xAA}},

    {"LD A, (C)", {.A = 0xBB, .C = 0xCC}, 2, {.C = 0xCC}, {}, {}},
    {"LD (C), A", {.A = 0xAA, .C = 0xCC}, 2, {.A = 0xAA, .C = 0xCC}, {0xFFCC}, {0xAA}},
    {"LD A, (0xFF34)", {.A = 0xAA}, 3, {}, {}, {}},
    {"LD A (0x34)", {.A = 0xAA}, 4, {}, {}, {}},

    {"LD (0xFF34), A", {.A = 0xAA}, 3, {.A = 0xAA}, {0xFF34}, {0xAA}},
    {"LD (0x34), A", {.A = 0xAA}, 4, {.A = 0xAA}, {0x0034}, {0xAA}},

    {"LD A, (HLI)", {.A = 0xAA, .H = 0x01, .L = 0xFF}, 2, {.H = 0x02, .L = 0x00}, {}, {}},
    {"LD A, (HLD)", {.A = 0xAA, .H = 0x02, .L = 0x00}, 2, {.H = 0x01, .L = 0xFF}, {}, {}},

    {"LD (HLI), A", {.A = 0xAA, .H = 0x01, .L = 0xDD}, 2, {.A = 0xAA, .H = 0x01, .L = 0xDE}, {0x01DD}, {0xAA}},
    {"LD (HLD), A", {.A = 0xAA, .H = 0x01, .L = 0xDD}, 2, {.A = 0xAA, .H = 0x01, .L = 0xDC}, {0x01DD}, {0xAA}},*/
