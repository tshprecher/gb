...
int test_cpu_exec() {
  ...
  struct test {
    ...
    {"RLC (HL)", {.H = 0x80, .L = 0x00}, 4, {.H = 0x80, .L = 0x00, .F = 0x80, .PC = 0x0002}, {}, {}},

    {"RL L", {.L = 0x80}, 2, { .F = 0x90, .PC = 0x0002}, {}, {}},
    {"RL D", {.D = 0x11}, 2, { .D = 0x22, .PC = 0x0002}, {}, {}},
    {"RL (HL)", {.H = 0x80, .L = 0x00}, 4, {.H = 0x80, .L = 0x00, .F = 0x80, .PC = 0x0002}, {}, {}},

    {"RRC C", {.C = 0x01}, 2, {.C = 0x80, .F = 0x10, .PC = 0x0002}, {}, {}},
    {"RRC (HL)", { .C = 0x01, .H = 0x80, .L = 0x00}, 4, {.C = 0x01, .H = 0x80, .L = 0x00, .F = 0x80, .PC = 0x0002}, {}, {}},

    {"RR A", {.A = 0x01}, 2, { .F = 0x90, .PC = 0x0002}, {}, {}},
    {"RR L", {.L = 0x8A}, 2, { .L = 0x45, .PC = 0x0002}, {}, {}},
    {"RR (HL)", {.H = 0x80, .L = 0x00}, 4, {.H = 0x80, .L = 0x00, .F = 0x80, .PC = 0x0002}, {}, {}},

    {"SLA D", {.D = 0x80}, 2, { .F = 0x90, .PC = 0x0002}, {}, {}},
    {"SLA E", {.E = 0xFF}, 2, { .E = 0xFE, .F = 0x10, .PC = 0x0002}, {}, {}},
    {"SLA (HL)", {.H = 0x80, .L = 0x00}, 4, {.H = 0x80, .L = 0x00, .F = 0x80, .PC = 0x0002}, {}, {}},

    {"SRA D", {.D = 0x8A}, 2, { .D = 0xC5, .PC = 0x0002}, {}, {}},
    {"SRA H", {.H = 0x01}, 2, { .F = 0x90, .PC = 0x0002}, {}, {}},
    {"SRA (HL)", {.H = 0x80, .L = 0x00}, 4, {.H = 0x80, .L = 0x00, .F = 0x80, .PC = 0x0002}, {}, {}},

    {"SRL A", {.A = 0x01}, 2, { .F = 0x90, .PC = 0x0002}, {}, {}},
    {"SRL C", {.C = 0xFF}, 2, { .C = 0x7F, .F = 0x10, .PC = 0x0002}, {}, {}},
    {"SRL (HL)", {.H = 0x80, .L = 0x00}, 4, {.H = 0x80, .L = 0x00, .F = 0x80, .PC = 0x0002}, {}, {}},

    {"SWAP A", {.A = 0x00}, 2, { .F = 0x80, .PC = 0x0002}, {}, {}},
    {"SWAP H", {.H = 0xF0}, 2, { .H = 0x0F, .PC = 0x0002}, {}, {}},
    {"SWAP (HL)", {.H = 0x80, .L = 0x00}, 4, {.H = 0x80, .L = 0x00, .F = 0x80, .PC = 0x0002}, {}, {}},
    ...
    {"SBC A, (HL)", {.A = 0x3B, .H = 0x80, .L = 0x00, .F = 0x10}, 2, {.A = 0x3A, .H = 0x80, .L = 0x00, .F = 0x40, .PC = 0x0001}, {}, {}},

    {"XOR A", {.A = 0xFF}, 1, {.F = 0x80, .PC = 0x0001}, {}, {}},
    {"XOR 0x0F", {.A = 0xFF}, 2, {.A = 0xF0, .PC = 0x0002}, {}, {}},
    {"XOR 0x8A", {.A = 0xFF}, 2, {.A = 0x75, .PC = 0x0002}, {}, {}},
    {"XOR (HL)", {.A = 0xFF, .H = 0x80, .L = 0x00}, 2, {.A = 0xFF, .H = 0x80, .L = 0x00,.PC = 0x0001}, {}, {}},
    ...
    {"CP (HL)", {.A = 0x3C, .H = 0x80, .L = 0x00}, 2, {.A = 0x3C, .H = 0x80, .L = 0x00, .F = 0x40, .PC = 0x0001}, {}, {}},
    ...
    {"BIT 0, (HL)", {.H = 0x80, .L = 0x00}, 3, {.H = 0x80, .L = 0x00, .F = 0xA0, .PC = 0x0002}, {}, {}},
