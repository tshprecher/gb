...
static struct inst instructions[] = {
  ...
  {ADC, 1, 1, 2, "10001110", "ADC A, (HL)"},
  {ADC, 2, 2, 2, "11001110 {n}", "ADC A, {n}"},

  {ADD, 0, 1, 1, "10000{r}", "ADD A, {r}"},
  {ADD, 1, 1, 2, "10000110", "ADD A, (HL)"},
  {ADD, 2, 2, 2, "11000110 {n}", "ADD A, {n}"},
  {ADD, 3, 2, 4, "11101000 {e}", "ADD SP, {e}"},
  {AND, 4, 1, 1, "10100{r}", "AND {r}"},
  {AND, 5, 1, 2, "00{ss}1001", "ADD HL, {ss}"},
  {AND, 6, 1, 2, "10100110", "AND (HL)"},
  {AND, 7, 2, 2, "11100110 {n}", "AND {n}"},
  ...
  {CP, 1,1, 2, "10111110", "CP (HL)"},
  {CP, 2,2, 2, "11111110 {n}", "CP {n}"},
  ...
  {SUB,1 ,1, 2, "10010110", "SUB (HL)"},
  {SUB,2 ,2, 2, "11010110 {n}", "SUB {n}"},
